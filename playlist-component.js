...
export class PlaylistComponent extends DDDSuper(I18NMixin(LitElement)) {
  ...
  constructor() {
    ...
    this.registerLocalization({
      context: this,
      localesPath:
        new URL("./locales/playlist-component.ar.json", import.meta.url).href +
        "/../",
    });
  }
  ...
  static get styles() {
    ...
    css`
      ...
      h3 span {
        font-size: var(--playlist-component-label-font-size, var(--ddd-font-size-s));
      }
    `];
  }
